...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.celisapp.resource"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("API  Spring Boot com Mongo DB",
				"Esta API foi desenvolvida com Spring Boot e Mongo DB para aplicar conhecimentos adquiridos no curso"
				+ " do Professor Nelio Alves", "Versão 1.0",
				"https://www.udemy.com/terms",
				new Contact("André Luis Celis", "https://github.com/AndreLuisCelis", "andreluiscelis@celisapp.com"),
